...
fig = [];
%% Multistart
[best_params,fval,tElapsed] = run_multistartContRC_test(DataSystem, VarSystem, x0, lb, ub, numStarts) 
...
%% Globalsearch
[best_params,fval,tElapsed] = run_globalsearchContRC_test(DataSystem, VarSystem, x0, lb, ub, numStarts) 
...
%% Genetic 
[best_params,fval,tElapsed] = run_geneticContRC_test(DataSystem, VarSystem, x0, lb, ub, numStarts) 
...
%% PatternSearch
[best_params, fval, tElapsed] = run_patternSearchContRC_test(DataSystem, VarSystem, x0, lb, ub, numStarts) 
...
%% Simulated Annealing
[best_params, fval, tElapsed] = run_simulatedAnnealingContRC_test(DataSystem, VarSystem, x0, lb, ub, numStarts)
...
%% Surrogate 
[best_params,fval,tElapsed] = run_surrogateContRC_test(DataSystem, VarSystem, lb, ub, numStarts)
