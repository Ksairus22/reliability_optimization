function [best_params,fval,tElapsed] = run_gamultiobjContRC_multi(DataSystem,goalfreq, IteratorCapacitor, IteratorDiod, IteratorResistor_B, IteratorResistor_K, IteratorTransistor,... 
